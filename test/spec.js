...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Artist = __webpack_require__(176);
	...
	describe('Artist', function () {
	  ...
	  beforeEach(function () {
	    component = TestUtils.renderIntoDocument(_addons2.default.createElement(_Artist2.default, { name: 'Run the Jewels' }));
	  });

	  it('should display the correct artist name', function () {
